...
// register wedding_band_Recent_Post widget
function wedding_band_register_recent_post_widget() {
    register_widget( 'wedding_band_Recent_Post' );
}
add_action( 'widgets_init', 'wedding_band_register_recent_post_widget' );
 
 /**
 * Adds wedding_band_Recent_Post widget.
 */
class wedding_band_Recent_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'wedding_band_recent_post', // Base ID
			__( 'RARA: Recent Post', 'wedding-band' ), // Name
			array( 'description' => __( 'A Recent Post Widget', 'wedding-band' ), ) // Args
		);
	}
...
} // class wedding_band_Recent_Post 