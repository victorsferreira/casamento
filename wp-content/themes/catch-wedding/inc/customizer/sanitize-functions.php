<?php
/**
 * Catch Wedding Theme Options Sanitization Functions
 *
 ...
 */
function catch_wedding_sanitize_select( $input, $setting ) {
 ...
 */
function catch_wedding_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function catch_wedding_sanitize_post( $input ) {
 ...
 */
function catch_wedding_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function catch_wedding_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function catch_wedding_sanitize_number_range( $number, $setting ) {
 ...
 * @return string
 */
function catch_wedding_sanitize_date_time( $input ) {
